defmodule ReportsFreelasTest do
  ...
  alias ReportsFreelas

  @file_name "report_full.csv"
  ...
  describe "build/1" do
    test "builds the report" do
      ...
      response = ReportsFreelas.build(@file_name)

      assert response == expected_response
    end

    test "When no filename was given, returns an error" do
      response = ReportsFreelas.build()
  ...
  describe "build_from_many" do
    test "When a file list is provided, builds the report" do
      ...
      response = ReportsFreelas.build_from_many(@file_names)

      assert response == expected_response
    end

    test "When no filenames was given, returns an error" do
      response = ReportsFreelas.build_from_many()
